...
export const ButtonCreateNewApp: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Create New App - Ranoar No-Code</title> {/* Set title for the Create New App page */}
                <meta name="description" content="Create a new app with pre-designed templates or start from scratch" />
            </Helmet>
