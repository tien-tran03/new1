...
import { NavbarIcon } from "../element_layout/navigation";
import { DropdownIcon } from "../element_layout/dropdown/dropdown-icons";
            ...
            <div className="grid grid-cols-3 gap-1 px-1 py-1">
              {groupedElements[groupName].map((element: ElementData) => (
                <div className="flex items-center justify-center w-full">
                  ...
                  {element.name === "Navbar" && <NavbarIcon />}
                  {element.name === "Dropdown" && <DropdownIcon />}
                </div>
              ))}
            </div>
          )}
