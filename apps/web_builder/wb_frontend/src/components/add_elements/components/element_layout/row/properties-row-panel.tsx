...
export const RowProperties: React.FC<RowPropertiesProps> = ({
  properties,
  onPropertyChange,
  size = "small",
}) => {
  ...
  const sections = [
    { id: "layout", label: "Layout", details: ["rowCount", "gap"] },
          ...
          >
            ...
            <AccordionDetails sx={{ bgcolor: "#1f2937", p: 0.5 }}>
              <Box sx={{ display: "flex", flexDirection: "column", gap: 0.5 }}>
                {section.details.includes("rowCount") && (
                  <Box display="flex" alignItems="center" gap={0.5}>
                    ...
                    <Slider
                      ...
                      onChange={(_, value) => handleChange("rowCount", value as number)}
                      min={1}
                      max={12}
                      step={1}
